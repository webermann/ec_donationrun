...
Class Tx_EcDonationrun_Domain_Model_Assignment Extends Tx_Extbase_DomainObject_AbstractEntity {
	...
	Protected $project;
		...
		/**
		 * The user role
		 * @var Tx_EcDonationrun_Domain_Model_Role
		 * @lazy
		 */
	Protected $role;
		 ...
		 * @var Tx_Extbase_Persistence_ObjectStorage<Tx_EcDonationrun_Domain_Model_Timeset>
		 * @lazy
		 * @cascade remove
		 */
	Protected $timesets;
		 ...
		 */
		  ...
		  * @param Tx_EcDonationrun_Domain_Model_Project $project The project
		  * @param Tx_EcDonationrun_Domain_Model_Role    $role    The user role
		  *
		  */

	Public Function __construct ( Tx_Extbase_Domain_Model_FrontendUser      $user    = NULL,
	                              Tx_EcDonationrun_Domain_Model_Project $project = NULL,
	                              Tx_EcDonationrun_Domain_Model_Role    $role    = NULL) {
	...
	Public Function getUser() { Return $this->user; }
		 ...
		 *
		 * Gets the project.
		 * @return Tx_EcDonationrun_Domain_Model_Project The project
		 *
		 */
	...
	Public Function getProject() {
		 ...
		 * @return Tx_Extbase_Persistence_ObjectStorage<Tx_EcDonationrun_Domain_Model_Timeset> All timesets
		 *
		 */
	...
	Public Function getTimesets() { Return $this->timesets; }
		 ...
		 *
		 * Gets the user role.
		 * @return Tx_EcDonationrun_Domain_Model_Role The user role
		 *
		 */
	...
	Public Function setProject(Tx_EcDonationrun_Domain_Model_Project $project) { $this->project = $project; }
	...
	Public Function setRole(Tx_EcDonationrun_Domain_Model_Role $role) { $this->role = $role; }
		 ...
		 * @param Tx_EcDonationrun_Domain_Model_Timeset $timeset A timeset
		 * @return void
		 *
		 */
	
	Public Function addTimeset(Tx_EcDonationrun_Domain_Model_Timeset $timeset) {
