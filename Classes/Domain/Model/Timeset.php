...
Class Tx_EcDonationrun_Domain_Model_Timeset Extends Tx_Extbase_DomainObject_AbstractEntity {
		...
		/**
		 * The assignment
		 * @var Tx_EcDonationrun_Domain_Model_Assignment
		 */
	...
	Protected $comment;
		 ...
		 */
		  ...
		  *
		  * Gets the assignment
		  * @return Tx_EcDonationrun_Domain_Model_Assignment The assignment
		  *
		  */
	...
	Public Function getComment() { Return $this->comment; }
		 ...
		 */
		  ...
		  * @param Tx_EcDonationrun_Domain_Model_Assignment $assignment The assignment
		  * @return void
		  *
		  */

	Public Function setAssignment(Tx_EcDonationrun_Domain_Model_Assignment $assignment) { $this->assignment = $assignment; }
