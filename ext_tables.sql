CREATE TABLE tx_ecdonationrun_domain_model_project (
...
CREATE TABLE tx_ecdonationrun_domain_model_role (
	uid int(11) NOT NULL auto_increment,
	pid int(11) DEFAULT '0' NOT NULL,
...
CREATE TABLE tx_ecdonationrun_domain_model_assignment (
	uid int(11) NOT NULL auto_increment,
	pid int(11) DEFAULT '0' NOT NULL,
...
CREATE TABLE tx_ecdonationrun_domain_model_timeset (
	uid int(11) NOT NULL auto_increment,
	pid int(11) DEFAULT '0' NOT NULL,
